...
const HeaderComponent = ({ title }: any) => (
  <View style={{width: '100%', position: 'absolute', top: 0, left: 0}}>
    <View style={{width: '100%', flexDirection: 'row', paddingHorizontal: 25, paddingTop: statusBarHeight + 20, alignItems: 'center'}}>
      <Icon name={'chevron-small-left'} type={'entypo'} color={'#FFF'} size={45} />
